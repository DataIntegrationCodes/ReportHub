...
<svg class="report-chart" viewBox="0 0 760 240" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="63" y="66" width="50" height="124" rx="4" fill="#3b82f6"/>
  <text x="88" y="60" fill="#52525b" font-size="11" text-anchor="middle">3.65</text>
  <text x="88" y="205" fill="#6b7280" font-size="10" text-anchor="middle">11 May</text>

  <rect x="138" y="130" width="50" height="60" rx="4" fill="#3b82f6"/>
  <text x="163" y="124" fill="#52525b" font-size="11" text-anchor="middle">1.76</text>
  <text x="163" y="205" fill="#6b7280" font-size="10" text-anchor="middle">18 May</text>

  <rect x="214" y="175" width="50" height="15" rx="4" fill="#3b82f6"/>
  <text x="239" y="169" fill="#52525b" font-size="11" text-anchor="middle">0.45</text>
  <text x="239" y="205" fill="#6b7280" font-size="10" text-anchor="middle">25 May</text>

  <circle cx="314" cy="190" r="4" fill="#dc2626"/>
  <text x="314" y="169" fill="#dc2626" font-size="11" text-anchor="middle">0.00 &#9888;</text>
  <text x="314" y="205" fill="#6b7280" font-size="10" text-anchor="middle">01 Jun</text>

  <rect x="365" y="87" width="50" height="103" rx="4" fill="#3b82f6"/>
  <text x="390" y="81" fill="#52525b" font-size="11" text-anchor="middle">3.04</text>
  <text x="390" y="205" fill="#6b7280" font-size="10" text-anchor="middle">08 Jun</text>

  <rect x="441" y="90" width="50" height="100" rx="4" fill="#3b82f6"/>
  <text x="466" y="84" fill="#52525b" font-size="11" text-anchor="middle">2.94</text>
  <text x="466" y="205" fill="#6b7280" font-size="10" text-anchor="middle">15 Jun</text>

  <rect x="516" y="50" width="50" height="140" rx="4" fill="#3b82f6"/>
  <text x="541" y="44" fill="#52525b" font-size="11" text-anchor="middle">4.12</text>
  <text x="541" y="205" fill="#6b7280" font-size="10" text-anchor="middle">22 Jun</text>

  <rect x="592" y="29" width="50" height="161" rx="4" fill="#3b82f6"/>
  <text x="617" y="23" fill="#52525b" font-size="11" text-anchor="middle">4.74</text>
  <text x="617" y="205" fill="#6b7280" font-size="10" text-anchor="middle">29 Jun</text>

  <rect x="667" y="148" width="50" height="42" rx="4" fill="#dc2626"/>
  <text x="692" y="142" fill="#111827" font-size="11" text-anchor="middle">1.24 &#9888;</text>
  <text x="692" y="205" fill="#52525b" font-size="10" text-anchor="middle">06 Jul (this wk)</text>
</svg>
...
<svg class="report-chart" viewBox="0 0 780 150" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="660" y="80" width="55" height="30" rx="4" fill="#1d4ed8"/>
  <text x="687" y="74" fill="#111827" font-size="10" text-anchor="middle">5.4</text>
...
<svg class="report-chart" viewBox="0 0 780 150" xmlns="http://www.w3.org/2000/svg">
  ...
  <polyline points="93,61 178,63 263,85 348,65 433,31 518,43 603,67 688,58" fill="none" stroke="#b45309" stroke-width="2"/>
  ...
  <circle cx="688" cy="58" r="4" fill="#b45309"/>
  <text x="688" y="49" fill="#b45309" font-size="10" text-anchor="middle">1.29x</text>
