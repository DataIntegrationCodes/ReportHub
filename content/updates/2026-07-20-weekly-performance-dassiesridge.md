...
<svg class="report-chart" viewBox="0 0 760 240" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="63" y="130" width="50" height="60" rx="4" fill="#3b82f6"/>
  <text x="88" y="124" fill="#52525b" font-size="11" text-anchor="middle">1.76</text>
  <text x="88" y="205" fill="#6b7280" font-size="10" text-anchor="middle">18 May</text>
  <rect x="138" y="175" width="50" height="15" rx="4" fill="#3b82f6"/>
  <text x="163" y="169" fill="#52525b" font-size="11" text-anchor="middle">0.45</text>
  <text x="163" y="205" fill="#6b7280" font-size="10" text-anchor="middle">25 May</text>
  <circle cx="239" cy="190" r="4" fill="#dc2626"/>
  <text x="239" y="169" fill="#dc2626" font-size="11" text-anchor="middle">0.00 &#9888;</text>
  <text x="239" y="205" fill="#6b7280" font-size="10" text-anchor="middle">01 Jun</text>
  <rect x="289" y="87" width="50" height="103" rx="4" fill="#3b82f6"/>
  <text x="314" y="81" fill="#52525b" font-size="11" text-anchor="middle">3.04</text>
  <text x="314" y="205" fill="#6b7280" font-size="10" text-anchor="middle">08 Jun</text>
  <rect x="365" y="90" width="50" height="100" rx="4" fill="#3b82f6"/>
  <text x="390" y="84" fill="#52525b" font-size="11" text-anchor="middle">2.94</text>
  <text x="390" y="205" fill="#6b7280" font-size="10" text-anchor="middle">15 Jun</text>
  <rect x="441" y="50" width="50" height="140" rx="4" fill="#3b82f6"/>
  <text x="466" y="44" fill="#52525b" font-size="11" text-anchor="middle">4.12</text>
  <text x="466" y="205" fill="#6b7280" font-size="10" text-anchor="middle">22 Jun</text>
  <rect x="516" y="29" width="50" height="161" rx="4" fill="#3b82f6"/>
  <text x="541" y="23" fill="#52525b" font-size="11" text-anchor="middle">4.74</text>
  <text x="541" y="205" fill="#6b7280" font-size="10" text-anchor="middle">29 Jun</text>
  <rect x="592" y="148" width="50" height="42" rx="4" fill="#3b82f6"/>
  <text x="617" y="142" fill="#52525b" font-size="11" text-anchor="middle">1.24</text>
  <text x="617" y="205" fill="#6b7280" font-size="10" text-anchor="middle">06 Jul</text>
  <rect x="667" y="172" width="50" height="18" rx="4" fill="#dc2626"/>
  <text x="692" y="166" fill="#111827" font-size="11" text-anchor="middle">0.53 &#9888;</text>
  <text x="692" y="205" fill="#52525b" font-size="10" text-anchor="middle">13 Jul (this wk)</text>
</svg>
...
<svg class="report-chart" viewBox="0 0 780 150" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="660" y="77" width="55" height="33" rx="4" fill="#1d4ed8"/>
  <text x="687" y="71" fill="#111827" font-size="10" text-anchor="middle">5.9</text>
...
<svg class="report-chart" viewBox="0 0 780 150" xmlns="http://www.w3.org/2000/svg">
  ...
  <polyline points="93,61 178,63 263,85 348,65 433,31 518,43 603,67 688,62" fill="none" stroke="#b45309" stroke-width="2"/>
  ...
  <circle cx="688" cy="62" r="4" fill="#b45309"/>
  <text x="688" y="53" fill="#b45309" font-size="10" text-anchor="middle">1.27x</text>
...
<svg class="report-chart" viewBox="0 0 760 240" xmlns="http://www.w3.org/2000/svg">
  <text x="10" y="16" fill="#52525b" font-size="12">Share of hours declared &lt;2h before execution (%)</text>
  <line x1="50" y1="190" x2="730" y2="190" stroke="#d1d5db" stroke-width="1"/>
  <rect x="63" y="41" width="50" height="149" rx="4" fill="#3b82f6"/>
  <text x="88" y="35" fill="#52525b" font-size="11" text-anchor="middle">39.3%</text>
  <text x="88" y="205" fill="#6b7280" font-size="10" text-anchor="middle">18 May</text>
  <rect x="138" y="114" width="50" height="76" rx="4" fill="#3b82f6"/>
  <text x="163" y="108" fill="#52525b" font-size="11" text-anchor="middle">20.2%</text>
  <text x="163" y="205" fill="#6b7280" font-size="10" text-anchor="middle">25 May</text>
  <rect x="214" y="188" width="50" height="2" rx="1" fill="#6b7280"/>
  <text x="239" y="182" fill="#6b7280" font-size="11" text-anchor="middle">0.0% &#9888;</text>
  <text x="239" y="205" fill="#6b7280" font-size="10" text-anchor="middle">01 Jun</text>
  <rect x="289" y="71" width="50" height="119" rx="4" fill="#3b82f6"/>
  <text x="314" y="65" fill="#52525b" font-size="11" text-anchor="middle">31.5%</text>
  <text x="314" y="205" fill="#6b7280" font-size="10" text-anchor="middle">08 Jun</text>
  <rect x="365" y="109" width="50" height="81" rx="4" fill="#3b82f6"/>
  <text x="390" y="103" fill="#52525b" font-size="11" text-anchor="middle">21.4%</text>
  <text x="390" y="205" fill="#6b7280" font-size="10" text-anchor="middle">15 Jun</text>
  <rect x="441" y="84" width="50" height="106" rx="4" fill="#3b82f6"/>
  <text x="466" y="78" fill="#52525b" font-size="11" text-anchor="middle">28.0%</text>
  <text x="466" y="205" fill="#6b7280" font-size="10" text-anchor="middle">22 Jun</text>
  <rect x="516" y="82" width="50" height="108" rx="4" fill="#3b82f6"/>
  <text x="541" y="76" fill="#52525b" font-size="11" text-anchor="middle">28.6%</text>
  <text x="541" y="205" fill="#6b7280" font-size="10" text-anchor="middle">29 Jun</text>
  <rect x="592" y="105" width="50" height="85" rx="4" fill="#3b82f6"/>
  <text x="617" y="99" fill="#52525b" font-size="11" text-anchor="middle">22.6%</text>
  <text x="617" y="205" fill="#6b7280" font-size="10" text-anchor="middle">06 Jul</text>
  <rect x="667" y="120" width="50" height="70" rx="4" fill="#1d4ed8"/>
  <text x="692" y="114" fill="#111827" font-size="11" text-anchor="middle">18.5%</text>
  <text x="692" y="205" fill="#52525b" font-size="10" text-anchor="middle">13 Jul (this wk)</text>
</svg>
