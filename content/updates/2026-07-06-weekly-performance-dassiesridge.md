...
<svg class="report-chart" viewBox="0 0 760 240" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="63" y="20" width="50" height="170" fill="#60a5fa"/>
  <text x="88" y="14" fill="#a0a0a0" font-size="11" text-anchor="middle">5.12</text>
  <text x="88" y="205" fill="#6b6b6b" font-size="10" text-anchor="middle">04 May</text>

  <rect x="138" y="69" width="50" height="121" fill="#60a5fa"/>
  <text x="163" y="62" fill="#a0a0a0" font-size="11" text-anchor="middle">3.65</text>
  <text x="163" y="205" fill="#6b6b6b" font-size="10" text-anchor="middle">11 May</text>

  <rect x="214" y="132" width="50" height="58" fill="#60a5fa"/>
  <text x="239" y="125" fill="#a0a0a0" font-size="11" text-anchor="middle">1.76</text>
  <text x="239" y="205" fill="#6b6b6b" font-size="10" text-anchor="middle">18 May</text>

  <rect x="289" y="175" width="50" height="15" fill="#60a5fa"/>
  <text x="314" y="168" fill="#a0a0a0" font-size="11" text-anchor="middle">0.45</text>
  <text x="314" y="205" fill="#6b6b6b" font-size="10" text-anchor="middle">25 May</text>

  <circle cx="390" cy="190" r="4" fill="#f87171"/>
  <text x="390" y="168" fill="#f87171" font-size="11" text-anchor="middle">0.00 &#9888;</text>
  <text x="390" y="205" fill="#6b6b6b" font-size="10" text-anchor="middle">01 Jun</text>

  <rect x="440" y="89" width="50" height="101" fill="#60a5fa"/>
  <text x="465" y="82" fill="#a0a0a0" font-size="11" text-anchor="middle">3.04</text>
  <text x="465" y="205" fill="#6b6b6b" font-size="10" text-anchor="middle">08 Jun</text>

  <rect x="516" y="92" width="50" height="98" fill="#60a5fa"/>
  <text x="541" y="85" fill="#a0a0a0" font-size="11" text-anchor="middle">2.94</text>
  <text x="541" y="205" fill="#6b6b6b" font-size="10" text-anchor="middle">15 Jun</text>

  <rect x="591" y="53" width="50" height="137" fill="#60a5fa"/>
...
<svg class="report-chart" viewBox="0 0 780 260" xmlns="http://www.w3.org/2000/svg">
  <text x="10" y="16" fill="#a0a0a0" font-size="12">Monthly exported production (GWh, bars) vs. average weighting factor (line)</text>
  <line x1="50" y1="190" x2="730" y2="190" stroke="#4a4a4a" stroke-width="1"/>
  <text x="45" y="88" fill="#6b6b6b" font-size="9" text-anchor="end">1.0x</text>
  <text x="45" y="23" fill="#6b6b6b" font-size="9" text-anchor="end">1.5x</text>

  <rect x="65" y="100.0" width="55" height="90.0" fill="#60a5fa"/>
  <text x="92" y="94" fill="#a0a0a0" font-size="10" text-anchor="middle">14.4</text>
  <text x="92" y="205" fill="#6b6b6b" font-size="10" text-anchor="middle">Dec</text>

  <rect x="150" y="101.25" width="55" height="88.75" fill="#60a5fa"/>
  <text x="177" y="95.25" fill="#a0a0a0" font-size="10" text-anchor="middle">14.2</text>
  <text x="177" y="205" fill="#6b6b6b" font-size="10" text-anchor="middle">Jan</text>

  <rect x="235" y="119.4" width="55" height="70.6" fill="#60a5fa"/>
  <text x="262" y="113.4" fill="#a0a0a0" font-size="10" text-anchor="middle">11.3</text>
  <text x="262" y="205" fill="#6b6b6b" font-size="10" text-anchor="middle">Feb</text>

  <rect x="320" y="127.5" width="55" height="62.5" fill="#60a5fa"/>
  <text x="347" y="121.5" fill="#a0a0a0" font-size="10" text-anchor="middle">10.0</text>
  <text x="347" y="205" fill="#6b6b6b" font-size="10" text-anchor="middle">Mar</text>

  <rect x="405" y="95.0" width="55" height="95.0" fill="#60a5fa"/>
  <text x="432" y="89" fill="#a0a0a0" font-size="10" text-anchor="middle">15.2</text>
  <text x="432" y="205" fill="#6b6b6b" font-size="10" text-anchor="middle">Apr</text>

  <rect x="490" y="114.4" width="55" height="75.6" fill="#60a5fa"/>
  <text x="517" y="108.4" fill="#a0a0a0" font-size="10" text-anchor="middle">12.1</text>
  <text x="517" y="205" fill="#6b6b6b" font-size="10" text-anchor="middle">May</text>

  <rect x="575" y="123.1" width="55" height="66.9" fill="#60a5fa"/>
  ...
  <text x="177" y="43.5" fill="#fbbf24" font-size="10" text-anchor="middle">1.26x</text>
  <circle cx="262" cy="66.9" r="3" fill="#fbbf24"/>
  <text x="262" y="58.9" fill="#fbbf24" font-size="10" text-anchor="middle">1.14x</text>
  <circle cx="347" cy="52.9" r="3" fill="#fbbf24"/>
  <text x="347" y="44.9" fill="#fbbf24" font-size="10" text-anchor="middle">1.25x</text>
  <circle cx="432" cy="28.4" r="3" fill="#fbbf24"/>
  <text x="432" y="20.4" fill="#fbbf24" font-size="10" text-anchor="middle">1.44x</text>
  <circle cx="517" cy="36.9" r="3" fill="#fbbf24"/>
  ...
  <line x1="660" y1="227" x2="675" y2="227" stroke="#fbbf24" stroke-width="2"/>
